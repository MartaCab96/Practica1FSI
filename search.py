...
class Problem:
    ...
    def __init__(self, initial, goal=None):
        """Especifica el estado inicial y el estado solución"""
    ...
    def goal_test(self, state):
        """Devuelve verdadero si el estado es la solución"""
        return state == self.goal

    def path_cost(self, c, state1, action, state2):
        """Devuelve el coste de ir de state1 a state2"""
        return c + 1
...
def graph_search(problem, fringe):
    ...
    while fringe:
        ...
        if problem.goal_test(node.state):
            print("--> Número de nodos expandidos:", contador)
            return node
